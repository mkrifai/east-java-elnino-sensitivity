...
m_recent = df[df['periode_update'] == '2025-12']
unique_recent = m_recent[['id', 'kode_kabupaten_kota', 'nama_kabupaten_kota']].drop_duplicates().sort_values(by='id')
for _, r in unique_recent.iterrows():
